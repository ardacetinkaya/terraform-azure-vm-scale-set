resource "azurerm_lb_rule" "region_01_load_balancer_01_rule_01" {
  ...
  probe_id                       = azurerm_lb_probe.region_01_load_balancer_01_probe_01.id
  load_distribution              = "SourceIPProtocol"
  disable_outbound_snat          = true
}

resource "azurerm_lb_rule" "region_01_load_balancer_01_rule_02" {
  resource_group_name            = azurerm_resource_group.region_01.name
  loadbalancer_id                = azurerm_lb.region_01_load_balancer_01.id
